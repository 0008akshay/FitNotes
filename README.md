#  FitNotes
Simple Workout Tracker that let's yor track your daily workout.
View workout history, add new workout, edit or delete an existing workout.
Used HTML, CSS, JS, Bootstrap for front-end and Flask for back-end.

# Steps to follow to run this project on your system.
